...
vector<int> KMeans::Cluster(vector<double> data)
{
	vector<int> Label;
	int size = 0;
	size = (int) (data.size() / m_dimNum);
...
void KMeans::Init(vector<double> data)
{
	int size = (int) (data.size() / m_dimNum);
